...
" Vim Color File
" Name:       iterm2.vim
" Maintainer: https://github.com/joshdick/iterm2.vim/
" License:    The MIT License (MIT)
" Based On:   https://github.com/MaxSt/FlatColor/

" A companion [vim-airline](https://github.com/bling/vim-airline) theme is available at: https://github.com/joshdick/airline-iterm2.vim
...
let g:colors_name="iterm2"

" Set to "256" for 256-color terminals, or
" set to "16" to use your terminal emulator's native colors
" (a 16-color palette for this color scheme is available; see
" < https://github.com/joshdick/iterm2.vim/blob/master/README.md >
" for more information.)
if !exists("g:iterm2_termcolors")
  let g:iterm2_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:iterm2_terminal_italics")
  let g:iterm2_terminal_italics = 0
endif

" This function is based on one from FlatColor: https://github.com/MaxSt/FlatColor/
" Which in turn was based on one found in hemisu: https://github.com/noahfrederick/vim-hemisu/
let s:group_colors = {} " Cache of default highlight group settings, for later reference via `iterm2#extend_highlight`
function! s:h(group, style, ...)
  if (a:0 > 0) " Will be true if we got here from iterm2#extend_highlight
  ...
  if g:iterm2_terminal_italics == 0
...
function! iterm2#set_highlight(group, style)
  call s:h(a:group, a:style)
endfunction

function! iterm2#extend_highlight(group, style)
...
call s:h("Identifier", { "fg": s:dark_red }) " any variable name
...
call s:h("Typedef", { "fg": s:blue }) " A typedef
call s:h("Special", { "fg": s:dark_yellow }) " any special symbol
...
if get(g:, 'iterm2_hide_endofbuffer', 0)
...
call s:h("Search", { "fg": s:comment_grey, "bg": s:yellow }) " Last search pattern highlighting (see 'hlsearch'). Also used for similar items that need to stand out.
